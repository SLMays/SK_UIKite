...
-(void)initUI
{
    ...
    navigationBgView.image = [UIImage GradientImageFromColors:@[COLORWITHRGBA(171, 0, 166, 1),COLORWITHRGBA(70, 0, 180, 1)] ByGradientType:(GradientType_leftToRight) addSuperView:navigationBgView];
