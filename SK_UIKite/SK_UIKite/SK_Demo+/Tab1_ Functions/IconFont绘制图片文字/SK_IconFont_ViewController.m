...
-(void)initMainView
{
    ...
    UILabel * title = [UILabel initWithFrame:CGRectMake(0, 50, WIDTH_IPHONE, 35) Title:@"一周天气预报(Label形式)" TitleColor:RandomColor BgColor:nil Font:[UIFont boldSystemFontOfSize:20] TextAlignment:NSTextAlignmentCenter  Tag:1];
    ...
    for (int i=0; i<7; i++) {
        UILabel * day = [UILabel initWithFrame:CGRectMake(0, top+i*height, width, height) Title:dayArr[i] TitleColor:RandomColor BgColor:nil Font:[UIFont systemFontOfSize:20] TextAlignment:NSTextAlignmentRight  Tag:i];
