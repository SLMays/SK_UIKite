...
#import "SK_NoNav_WebViewController.h"

#define KEY_WINDOW  [[UIApplication sharedApplication]keyWindow]

@interface SK_NoNav_WebViewController ()<WKNavigationDelegate, WKUIDelegate>
...
@implementation SK_NoNav_WebViewController
...
{
    if (!_webView) {
        _webView = [[WKWebView alloc] initWithFrame:CGRectMake(0, Height_StatusBar, WIDTH_IPHONE, HAVE_TABBAR_HEIGHT+44)];
        ...
        _statusBarView = [UIView initWithFrame:CGRectMake(0, 0, WIDTH_IPHONE, Height_StatusBar) backgroundColor:[UIColor whiteColor] alpha:1.0];
